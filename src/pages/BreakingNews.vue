...
<template>
  <div class="main">
    <div  v-auto-animate class="main2 py-1 h-100">
          ...
          <div id="app" class="form-container shadow-lg d-flex align-items-center justify-content-center flex-shrink" style="width: 90%">
            <div class="row w-100">
              <div class="col-md-7 offset-md-3">
                <h2 class="mb-4 text-light">Breaking News</h2>
                <form @submit.prevent="handleSubmit" enctype="multipart/form-data" class="text-light">
                  ...
                  <div class="mb-3">
                    ...
                    <input class="form-control text-capitalize" v-model="formData.heading" placeholder="Sports/News/Politics/Notice" id="floatingTextarea" maxlength="48" />
                    <div class="text-muted mt-1" style="color: white !important; font-weight: 500">{{ formData.heading ? formData.heading.length : 0 }} / 48</div>
                  </div>
                  <div class="mb-3">
                    ...
                    <div class="text-muted mt-1" style="color: white !important; font-weight: 500">{{ formData.details ? formData.details.length : 0 }} / 250</div>
                  </div>
                  <div class="row">
      ...
      <div v-auto-animate v-if="submited" class="row">
              ...
              <div class="preview position-relative mt-1 border border-success">
                <div class="preview-header w-100 bg-transparent d-flex position-relative">
                  ...
                  <div class="w-100 d-flex align-items-center justify-content-center">
                    <span class="border border-2 border-light px-5 bg-warning shadow-lg">
                      <h3 class="fw-bolder">BREAKIG NEWS</h3>
                    </span>
                  </div>
                </div>
                <div class="position-relative preview-content border border-2 border-warning">
                  <div class="preview-body h-100 d-flex justify-content-center">
                    <div class="preview-image w-100">
                      <div v-auto-animate class="w-100 h-100 bg-transparent">
                        <div v-auto-animate class="w-100 h-100 bg-light position-relative" :style="{ backgroundImage: 'url(' + formData.image + ')', backgroundSize: 'cover', backgroundPosition: position }">
                  ...
                  <div v-auto-animate class="preview-details text-dark d-flex justify-content-center">
                    <div class="preview-details-body bg-light rounded py-2 px-2 text-center border border-warning overflow-x-hidden overflow-y-auto">
                      <h6 v-if="isMobile <= 529" class="fw-bold news-heading text-uppercase" </h6>
                      <h5 v-if="isMobile > 529" class="fw-bold news-heading text-uppercase" </h5>
                    </div>
                  </div>
                </div>
        ...
        <div v-auto-animate v-if="submited" class="preview2-area w-100 mt-3 mt-xl-0">
          <div class="preview2-container w-100 d-flex justify-content-center">
            <div class="preview2 position-relative mt-1">
              ...
              <div class="position-relative preview2-content border border-2 border-warning">
              ...
              <div class="preview2-content-area mt-4 p-4 d-flex align-items-center justify-content-center" style="height: 32.5%">
